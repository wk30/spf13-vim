...
```bash
    ...
    bash <(curl https://raw.githubusercontent.com/stackerzzq/vimc/master/bootstrap.sh -L)
```
...
```bash
    ...
    curl https://raw.githubusercontent.com/stackerzzq/vimc/master/bootstrap.sh -L -o - | sh
